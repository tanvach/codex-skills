...
description: >-
  Execute an ExecPlan from a work item under `.agent/work/` or, when
  necessary, from `.agent/execplan-pending.md`. Use when the user asks to
  implement a plan, execute the pending plan, or resume blocked implementation
  work.
---
